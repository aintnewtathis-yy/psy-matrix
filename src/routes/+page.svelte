...
<svelte:head>
	<title>Калькулятор психоматрицы - Пифагор</title>
	<meta name="description" content="Узнай, кем ты должен быть по своей дате рождения, какое у тебя предназначение, каким
	даром ты обладаешь, какие скрытые таланты у тебя есть, и как твои слабые стороны сделать
	твоей силой."/>
</svelte:head>